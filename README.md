...
> This repository baseline is the full QuantDinger tree at commit `e64e1c2`.
> DSA source is **not** imported as a tree; its modules migrate Plan-by-Plan
> (recorded in `UPSTREAM_SOURCES.md`).

Key documents: [DEVELOPMENT_PLAN第八版.md](./DEVELOPMENT_PLAN第八版.md) ·
[P14_SAFE_PROFILE.md](./P14_SAFE_PROFILE.md) · [AGENTS.md](./AGENTS.md) ·
[docs/BASELINE.md](./docs/BASELINE.md) · [THIRD_PARTY_NOTICES.md](./THIRD_PARTY_NOTICES.md)

Build & test entry points (from repo root):
