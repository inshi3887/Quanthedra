...
ALLOWED_DOCS_ROOT_FILES = {
    "README.md",
    "README_CN.md",
    # P0 audit records are intentionally kept at docs/ root because the
    # review prompt and baseline references define these paths as canonical.
    "BASELINE.md",
    "DEPENDENCY_REPORT.md",
    "DIRTY_MANIFEST_DSA.md",
    "DIRTY_MANIFEST_QUANTDINGER.md",
    "P0_BLOB_HASH_COMPARISON.md",
    "P0_CHECKLIST.md",
    "P0_ENVIRONMENT.md",
    "P0A_DELIVERY_REPORT.md",
}
