...
def list_credentials():
    ...
    try:
        ...
        for row in rows:
            ...
            try:
                plain = decrypt_credential_blob(item.get('encrypted_config'), PURPOSE_BROKER_CREDENTIAL)
...
def create_credential(data):
    ...
    try:
        ...
        stored_blob = encrypt_credential_blob(plaintext_config, PURPOSE_BROKER_CREDENTIAL)
